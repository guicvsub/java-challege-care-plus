...
CREATE TABLE `diet_plans` (
  ...
  `target_proteins` double NOT NULL,
  `updated_at` datetime(6) DEFAULT NULL,
  `patient_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK4bevpyh78eo1o4frt60s5dnrt` (`patient_id`),
  CONSTRAINT `FK4bevpyh78eo1o4frt60s5dnrt` FOREIGN KEY (`patient_id`) REFERENCES `pacientes` (`id`)
