...
class JwtServiceTestSimple {
    ...
    void setUp() {
        ...
        try {
            ...
            secretField.set(jwtService, "testSecretKeyForTesting123456789");
    ...
    void tokenInvalidoAssinaturaErrada_DeveSerRejeitado() {
        ...
        // validateToken também deve lançar exceção para token inválido
        assertThrows(Exception.class, () -> {
            jwtService.validateToken(invalidToken, testEmail);
        }, "Token com assinatura inválida não deveria ser válido");
    }
    ...
    void tokenExpirado_DeveRetornar401() throws InterruptedException {
        ...
        try {
            var secretField = JwtService.class.getDeclaredField("secret");
            secretField.setAccessible(true);
            secretField.set(shortLivedJwtService, "testSecretKeyForTesting123456789");
        ...
        // Token expirado deve lançar exceção ao validar
        assertThrows(Exception.class, () -> {
            shortLivedJwtService.validateToken(token, testEmail);
        }, "Token expirado deveria lançar exceção");
    }
